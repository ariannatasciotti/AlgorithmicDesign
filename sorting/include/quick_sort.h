...
void quicksort_rec(void *A, size_t left, size_t right, const size_t elem_size, total_order leq);


int* partition_3(void *A, size_t i, size_t j, size_t pivot, const size_t elem_size, total_order leq);

int partition(void *A, size_t i, size_t j, size_t pivot, const size_t elem_size, total_order leq);
